...
- Development version: `1.7.0-videolock.16`.
...
- Motion-triggered capture, HKSV recording, and two-way audio are not implemented. The motion service is only a short door-opening event.
