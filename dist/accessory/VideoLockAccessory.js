...
class VideoLockAccessory extends BaseAccessory_1.default {
    ...
    configureDoorOpenEvent() {
        ...
        this.getDoorOpenEventService()
            .setCharacteristic(this.Characteristic.ContactSensorState, this.Characteristic.ContactSensorState.CONTACT_DETECTED);
    }
    getDoorOpenEventService() {
        return this.accessory.getServiceById(this.Service.ContactSensor, 'door-open-event')
            || this.accessory.addService(this.Service.ContactSensor, `${this.device.name} Door Opened`, 'door-open-event');
    }
    configureDoorbell() {
    ...
    async onDeviceStatusUpdate(status) {
        ...
        if (doorOpenStatus) {
            ...
            if (isEvent && this.intialized) {
                ...
                characteristic.sendEventNotification(this.Characteristic.ContactSensorState.CONTACT_NOT_DETECTED);
                this.doorOpenTimer && clearTimeout(this.doorOpenTimer);
                this.doorOpenTimer = setTimeout(() => characteristic.updateValue(this.Characteristic.ContactSensorState.CONTACT_DETECTED), 30 * 1000);
            }
        }
...
exports.default = VideoLockAccessory;
//# sourceMappingURL=VideoLockAccessory.js.map