...
| Video Lock | 视频门锁 | videolock | LockMechanism<br> ContactSensor<br> Doorbell<br> Camera | ✅ | Implemented by this fork; ContactSensor prefers `open_close`/`closed_opened` and falls back to `lock_motor_state` |
