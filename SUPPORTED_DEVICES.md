...
| Video Lock | 视频门锁 | videolock | LockMechanism<br> ContactSensor<br> MotionSensor<br> Doorbell<br> Camera | ✅ | ContactSensor tracks door/lock state; MotionSensor reports `door_opened`/`open_inside` events |
