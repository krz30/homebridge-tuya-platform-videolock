...
| Video Lock | 视频门锁 | videolock | LockMechanism<br> ContactSensor<br> Doorbell<br> Camera | ✅ | Implemented by this fork; ContactSensor requires `open_close` or `closed_opened` |
